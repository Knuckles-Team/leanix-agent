...
5. **Domain-Specific Checks**:
   - **LeanIX Connectivity**: Execute a basic `get_factsheets` or `graphql_query` call (with a limit of 1) to ensure the LeanIX Workspace is reachable and the API Token is valid.

...
_MTM_ACTIONS = frozenset(
    {
        ...
        "get_data_breach_contact", "add_data_breach_contact", "delete_data_breach_contact", "get_accounts",
        "create_account", "get_account", "update_account", "delete_account",
        "get_contracts", "get_events", "get_instances", "get_settings",
        "get_users", "get_workspaces", "getapitokens", "createapitoken",
        "getapitoken", "updateapitoken", "deleteapitoken", "getfeature",
        "accessfeature", "getapplication", "getapplications", "getedition",
        "geteditions", "getfeatures", "create_contract", "get_contract",
        "update_contract", "delete_contract", "get_custom_features", "create_custom_feature",
        "get_custom_feature", "update_custom_feature", "delete_custom_feature", "deletedomain",
        "getdomain", "getdomains", "upsertdomain", "getidentityproviders",
        "getworkspaces_2", "create_event", "get_event", "update_event",
        "getraw", "get_export", "process_graph_ql", "get_identity_providers",
        "create_identity_provider", "get_identity_provider", "update_identity_provider", "delete_identity_provider",
        "get_domains", "get_metadata", "getworkspaces_3", "activate",
        "authenticate", "checkip", "invite", "login",
        "loginpractitioner", "logout", "reset_password", "review",
        "set_password", "switchpermissionrole", "inactive", "create_instance",
        "get_instance", "update_instance", "delete_instance", "getinstancesbyworkspace",
        "getpreferredinstance", "switchdefaultinstance", "list", "create",
        "invalidate", "getpermissions", "createpermission", "getpermission",
        "getsettings_2", "getuserrandom", "getsettings_3", "createsetting",
        "getsetting", "updatesetting", "deletesetting", "getnotificationsettings",
        "setworkspacenotificationstatus", "gettechnicalusers", "create_technical_user", "get_technical_user",
        "update_technical_user", "delete_technical_user", "replace_technical_user_api_token", "getusers_1",
        "createuser", "createuserpassword", "getevents_6", "getpermissions_1",
        "getsettings_4", "getuser", "updateuser", "getuserrandom_1",
        "setpassword_1", "create_workspace", "get_workspace", "update_workspace",
        "delete_workspace", "get_feature_bundle", "get_impersonations", "get_permission",
        "get_permission_stats", "get_permissions", "get_support_permissions", "get_user_list_export",
        "getworkspacesforbackup", "permissions_search", "getuserpiichanges", "get_user_segment",
        "create_or_update_user_segment", "getworkspacemaintenance", "createworkspacemaintenance", "deleteworkspacemaintenance",
        "get_contracts_1", "get_custom_features_1", "get_custom_features_2", "get_domains_1",
        "get_events_1", "get_events_2", "get_events_3", "get_events_4",
        "get_events_5", "get_events_6", "get_instances_1", "get_instances_2",
        "get_settings_1", "get_settings_2", "get_users_1", "get_users_2",

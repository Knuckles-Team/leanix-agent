...
name: leanix-starter
description: >-
  Leanix API + MCP Server + A2A Server Use when working with Leanix via this package's MCP
...
license: MIT
tags: [leanix-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Leanix Starter Skill

Starter skill for the **Leanix** package. Use the `mcp-client` universal skill
